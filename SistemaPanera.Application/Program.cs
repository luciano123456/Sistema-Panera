...
builder.Services.AddScoped<IProductoInsumoRepository<ProductosInsumo>, ProductoInsumoRepository>();
builder.Services.AddScoped<IProductoInsumoService, ProductoInsumoService>();
